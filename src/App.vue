...
<script>
  ...
  methods: {
    ...
    passloc(infoloc){
      ...
      var iwContent = `<div style="padding:5px;">${this.LocationObject.marketName}</div>`, // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
      iwPosition = new kakao.maps.LatLng(this.LocationObject.lat, this.LocationObject.lot); //인포윈도우 표시 위치입니다
